...
namespace Media.Growth.OptimiserWeb.Controllers
{
    public class CurrencyController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "CurrencyId,CurrencyName")] Currency currency)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "CurrencyId,CurrencyName")] Currency currency)
        {
            if (ModelState.IsValid)
            {
